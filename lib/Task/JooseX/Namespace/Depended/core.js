Class('JooseX.Namespace.Depended.Manager', {
    ...
    my : {
        ...
        methods : {
	        ...
	        use: function (dependenciesInfo, callback, scope, currentNs) {
                new Joose.Namespace.Keeper(null, {
	                use: dependenciesInfo,
	                body: function () {
	                    Joose.Namespace.Manager.my.executeIn(currentNs, callback, scope)
	                }
	            })
	        }
...
use = function (dependenciesInfo, callback, scope) {
    JooseX.Namespace.Depended.Manager.my.use(dependenciesInfo, callback, scope, Joose.Namespace.Manager.my.getCurrent()) 
}
...
Role('JooseX.Namespace.Depended', {
    ...
    override: {
        ...
        construct: function (extend) {
            ...
            //the case of pure namespace keeper creation (not Module)
