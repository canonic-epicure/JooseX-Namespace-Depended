Role('JooseX.Namespace.Depended', {
    ...
    override: {
        ...
        construct: function (extend) {
            ...
            //XXX can't depend from preloaded empty classes - they are always not ready, smthing should be done with this
            ...
            if (extend.use) {
                ...
                if (!this.readyListeners) debugger
                ...
                if (extend.resolveIsa) {
                    ...
                    if (typeof isaStr == 'object') Joose.O.each(isaStr, function (value, name) { isaStr = name })
