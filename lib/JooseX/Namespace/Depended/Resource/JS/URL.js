Class('JooseX.Namespace.Depended.Resource.JS.URL', {
    ...
    after: {
        ...
        initialize: function () {
            ...
            if (/^http/.test(url) || /^\//.test(url)) JooseX.Namespace.Depended.Transport.ScriptTag.meta.apply(this)
        }
...
JooseX.Namespace.Depended.Manager.my.registerResourceClass('jsurl', JooseX.Namespace.Depended.Resource.JS.URL)
